  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center">
        <Button type="button" variant="secondary" className="flex items-center justify-center gap-2 !w-auto !px-8" onClick={() => signIn('google', { callbackUrl: '/auth/callback?success=true' })}>
