...
export function CartItemCard({ item, onUpdateQuantity, onRemove, formatPrice }: CartItemCardProps) {
  return (
    <div className="flex gap-3 p-3 bg-gray-50 dark:bg-neutral-800 rounded-xl">
      {/* Image */}
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2 mt-2">
          <button
            ...
            className="w-7 h-7 rounded-full bg-gray-200 dark:bg-neutral-700 hover:bg-gray-300 dark:hover:bg-neutral-600 flex items-center justify-center text-gray-600 dark:text-neutral-400"
          >
      ...
      <button
        ...
        className="self-start p-1 text-gray-400 dark:text-neutral-500 hover:text-red-500 transition-colors"
      >
