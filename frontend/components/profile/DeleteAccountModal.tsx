  ...
  return (
    <>
      <button
        type="button"
        onClick={openModal}
        className="px-6 py-2 border border-red-300 dark:border-red-800 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/30 rounded-xl font-medium transition-colors"
      >
